...
- Updated API base URL in frontend to point to `http://localhost:3001`
...
The frontend is configured to connect to this backend at `http://localhost:3001/v1/api`. Make sure both servers are running:

1. Backend: `cd namlong && npm run dev` (port 3001)
