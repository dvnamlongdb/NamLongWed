...
const TEACHERS = [
  { value: "gv_1", label: "GV. Nguyễn Văn A" },
  { value: "gv_2", label: "GV. Trần Thị B" },
  { value: "gv_3", label: "GV. Phạm Văn C" },
  { value: "tg_1", label: "TG. Lê Văn D" },
  { value: "tg_2", label: "TG. Vũ Thị E" },
];
...
export default function TeachingSchedulePage() {
  const [selectedTeacher, setSelectedTeacher] = useState<string | null>("gv_1");
  ...
  const selectedTeacherLabel = useMemo(() => TEACHERS.find(t => t.value === selectedTeacher)?.label || "teacher", [selectedTeacher]);
